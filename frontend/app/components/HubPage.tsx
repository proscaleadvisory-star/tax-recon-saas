  ...
  return (
    <div className="cinematic-shell relative min-h-screen overflow-hidden bg-[#030406] text-slate-100">
      ...
      <main className="relative z-10 mx-auto flex min-h-[calc(100vh-92px)] w-full max-w-[1680px] flex-col px-6 pb-14 sm:px-10 lg:px-14">
        <section className="grid flex-1 items-center gap-10 py-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(580px,1.1fr)] lg:py-10">
          <motion.div
          ...
          >
            ...
            <h1 className="font-display text-[clamp(3.4rem,7.4vw,9rem)] font-black uppercase leading-[0.78] tracking-[-0.035em] text-slate-100">
              Client
            ...
            <p className="mt-8 max-w-2xl text-balance text-lg leading-8 text-slate-300/78">
              A premium dark command suite for finance and tax teams: reconcile payouts, GST credits, AIS/26AS evidence, SKU margins, forecasts, and audit packs from one launch-ready client console.
            </p>
              ...
              {launchProof.map((item, index) => {
                ...
                return (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 0.18 + index * 0.08, duration: 0.56 }}
          ...
          <div className="relative">
            <motion.div
              ...
              className="pointer-events-none absolute -left-16 -top-20 hidden h-80 w-80 rounded-full border border-cyan-200/15 bg-[radial-gradient(circle_at_center,rgba(103,232,249,0.18),rgba(15,23,42,0.1)_38%,transparent_68%)] shadow-[0_0_130px_rgba(103,232,249,0.15)] lg:block"
            >
              ...
              <Radar className="absolute left-1/2 top-1/2 h-16 w-16 -translate-x-1/2 -translate-y-1/2 text-cyan-100/70" />
            </motion.div>
            ...
            {modules.map((mod, index) => {
              ...
              return (
                <motion.button
                  ...
                  className={`cinematic-card group relative min-h-[270px] overflow-hidden rounded-[1.65rem] border bg-[#080a0f]/82 p-6 text-left shadow-[0_22px_90px_rgba(0,0,0,0.42)] backdrop-blur-xl transition duration-500 hover:-translate-y-2 ${accent.card} ${
                    index === 0 ? "sm:row-span-2 sm:min-h-[560px]" : ""
                  }`}
                >
                  ...
                  <div className="absolute -bottom-24 left-1/2 h-36 w-72 -translate-x-1/2 rounded-[100%] bg-white/[0.035] blur-2xl transition duration-700 group-hover:bg-white/[0.06]" />
